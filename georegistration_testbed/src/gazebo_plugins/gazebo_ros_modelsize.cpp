...
#include "gazebo_plugins/gazebo_ros_modelsize.h"

namespace gazebo {
    GZ_REGISTER_MODEL_PLUGIN(GazeboRosModelSize);

    ////////////////////////////////////////////////////////////////////////////////
    // Constructor

    GazeboRosModelSize::GazeboRosModelSize() {
        this->seed = 0;
    }
...
//        this->callback_queue_thread_.join();
    ...
    void GazeboRosModelSize::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf) {
        // Get the world name.
...
//                boost::bind(&GazeboRosP3D::UpdateChild, this));
    ...
    void GazeboRosModelSize::UpdateChild() {
//        if (!this->link_)
//            return;
...
//    double GazeboRosModelSize::GaussianKernel(double mu, double sigma) {
...
//    void GazeboRosModelSize::P3DQueueThread() {
